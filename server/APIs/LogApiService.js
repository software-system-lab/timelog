...
module.exports = class {
  ...
  SetAPI () {
    ...
    this.router.post('/AddALog', async (req, res) => {
      try {
        const result = await _LogProvider.AddALog(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(777)
    ...
    this.router.post('/ModifyALog', async (req, res) => {
      try {
        const result = await _LogProvider.ModifyALog(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(777)
    ...
    this.router.post('/DeleteALog', async (req, res) => {
      try {
        const result = await _LogProvider.DeleteALog(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/GetUserLogs', async (req, res) => {
      try {
        const result = await _LogProvider.GetUserLogsBySearch(req.body)
        const dbActivityList = await _LogProvider.GetUserActivities(req.body.UserID)
    ...
    this.router.post('/GetALog', async (req, res) => {
      try {
        const result = await _LogProvider.GetALog(req.body.LogID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/ModifyOrAddAnActivity', async (req, res) => {
      try {
        const result = await _LogProvider.ModifyOrAddAnActivity(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/DeleteAnActivity', async (req, res) => {
      try {
        const result = await _LogProvider.DeleteAnActivity(req.body.ActivityID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/ModifyOrAddAGoal', async (req, res) => {
      try {
        const result = await _LogProvider.ModifyOrAddAGoal(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/ActivityTimeByTimeBox', async (req, res) => {
      try {
        const body = req.body
        const activities = await this.logService.getActivityTimeByTimeBox(body.UserID, body.TimeBoxID)
        res.send(activities)
      } catch (err) {
        console.log(err)
        res.send(400)

...
async function getCurrentTimeBox (userID) {
  const timeBoxList = await _profileProvider.GetTimeBoxes(userID)
  let result = null
  const now = moment(Date.now())
  timeBoxList.forEach(timeBox => {
    const start = moment(timeBox.StartDate)
    const end = moment(timeBox.EndDate).add(1, 'days')
    const update = moment(timeBox.UpdateTime)
...
module.exports = class {
  ...
  SetAPI () {
    this.router.post('/GetProfile', async function (req, res) {
      try {
        const result = await _profileProvider.GetUserProfile(req.body.FBID)
        // const currentTimeBoxInfo = await _logProvider.QueryTimeBoxByTimeBoxID(result.CurrentTimeBoxID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/Login', async function (req, res) {
      try {
        const result = await _profileProvider.Login(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/Register', async function (req, res) {
      try {
        const result = await _profileProvider.Register(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/EditUserProfile', async function (req, res) {
      try {
        const result = await _profileProvider.EditUserProfile(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.get('/GetTeamList', async function (req, res) {
      try {
        ...
        const result = await _profileProvider.GetTeamList(UserID)
    ...
    this.router.post('/GetTeammates', async function (req, res) {
      try {
        const result = await _profileProvider.GetTeammatesByTeamID(req.body.TeamID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.status(404)
    ...
    this.router.post('/GetTimeBoxes', async function (req, res) {
      try {
        const result = await _profileProvider.GetTimeBoxes(req.body.UserID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/GetTimeBoxByID', async function (req, res) {
      try {
        const result = await _profileProvider.GetTimeBoxByID(req.body.TimeBoxID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/EditTimeBox', async function (req, res) {
      try {
        const result = await _profileProvider.EditTimeBox(req.body)
        if (result) {
    ...
    this.router.post('/DeleteTimeBox', async function (req, res) {
      try {
        const result = await _profileProvider.DeleteTimeBox(req.body.SprintID)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)
    ...
    this.router.post('/ChangeTimeBox', async function (req, res) {
      try {
        const result = await _profileProvider.ChangeTimeBox(req.body)
        res.send(result)
      } catch (err) {
        console.log(err)
        res.send(400)

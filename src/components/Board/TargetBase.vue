...
<el-col :md="6" :sm="6">
  ...
  <el-row>
    <el-input :disabled="!changeBoxEnable" size="mini" type="number" step="1" min="1" placeholder="Target (in Hour)" suffix-icon="el-icon-edit-outline" v-model="tag.TimeTarget">
    </el-input>
  </el-row>
  <!-- <el-row>
